...
// HarmonyProver function
describe('HarmonyProver', function () {
    beforeEach(async function () {

        // MMRVerifier is deployed
        ...
        // HarmonyProver is deployed with the previously deployed MMRVerifier address
    ...
    // TEST
    // this tests the HarmonyProver toBlockHeader function, calls the function and checks if the hash of the outputed head si the same as headerData hash
    ...
    // getReceiptProof returns expectedRoot: block.receiptsRoot,key , proof, keyIndex, proofIndex, expectedValue,header
    // calls the rpcWrapper in utils.js and it retuns txProof
    // checks if the txProof header has is the same as the transactions header from (transaction.json)
